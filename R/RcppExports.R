...
CVXcanon__solve <- function(sense, objective, constraintsLinOpVector, solverOptions) {
    .Call('_cvxr_CVXcanon__solve', PACKAGE = 'cvxr', sense, objective, constraintsLinOpVector, solverOptions)
}
...
ProblemData__getV <- function(xp) {
    .Call('_cvxr_ProblemData__getV', PACKAGE = 'cvxr', xp)
}
...
ProblemData__getConstVec <- function(xp) {
    .Call('_cvxr_ProblemData__getConstVec', PACKAGE = 'cvxr', xp)
}
...
ProblemData__getI <- function(xp) {
    .Call('_cvxr_ProblemData__getI', PACKAGE = 'cvxr', xp)
}
...
ProblemData__getJ <- function(xp) {
    .Call('_cvxr_ProblemData__getJ', PACKAGE = 'cvxr', xp)
}
...
Solution__new <- function() {
    .Call('_cvxr_Solution__new', PACKAGE = 'cvxr')
}
...
Solution__get_status <- function(xp) {
    .Call('_cvxr_Solution__get_status', PACKAGE = 'cvxr', xp)
}
...
Solution__get_optimal_value <- function(xp) {
    .Call('_cvxr_Solution__get_optimal_value', PACKAGE = 'cvxr', xp)
}
...
Solution__get_primal_values <- function(xp) {
    .Call('_cvxr_Solution__get_primal_values', PACKAGE = 'cvxr', xp)
}
...
Solution__get_dual_values <- function(xp) {
    .Call('_cvxr_Solution__get_dual_values', PACKAGE = 'cvxr', xp)
}
