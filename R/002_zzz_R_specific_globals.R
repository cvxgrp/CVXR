...
## R-SPECIFIC: Global state and package-level initialization
...
.onLoad <- function(libname, pkgname) {
  ...
  ## Register S3 Ops group handler for Objective arithmetic (+, -, *, /)
  registerS3method("Ops", "CVXR::Objective", .objective_Ops_handler)
