...
.CseKeys__new <- function() {
    .Call(`_CVXR_CseKeys__new`)
}

.CseKeys__class_code <- function(s, cls) {
    .Call(`_CVXR_CseKeys__class_code`, s, cls)
}

.CseKeys__memo_get <- function(s, id) {
    .Call(`_CVXR_CseKeys__memo_get`, s, id)
}

.CseKeys__key_node <- function(s, id, class_code, shape, data_key, child_keys) {
    .Call(`_CVXR_CseKeys__key_node`, s, id, class_code, shape, data_key, child_keys)
}

.CseKeys__intern_ints <- function(s, id, tag, x) {
    .Call(`_CVXR_CseKeys__intern_ints`, s, id, tag, x)
}

.CseKeys__intern_doubles <- function(s, id, tag, x, dims) {
    .Call(`_CVXR_CseKeys__intern_doubles`, s, id, tag, x, dims)
}

.CseKeys__intern_sparse <- function(s, id, tag, i, j, x, dims) {
    .Call(`_CVXR_CseKeys__intern_sparse`, s, id, tag, i, j, x, dims)
}

.CseKeys__intern_strings <- function(s, id, tag, x) {
    .Call(`_CVXR_CseKeys__intern_strings`, s, id, tag, x)
}

.CseKeys__memo_size <- function(s) {
    .Call(`_CVXR_CseKeys__memo_size`, s)
}

.CseKeys__n_signatures <- function(s) {
    .Call(`_CVXR_CseKeys__n_signatures`, s)
}

.CseKeys__aa_get <- function(s, id) {
    .Call(`_CVXR_CseKeys__aa_get`, s, id)
}

.CseKeys__aa_set <- function(s, id, val) {
    invisible(.Call(`_CVXR_CseKeys__aa_set`, s, id, val))
}

.CseKeys__result_get <- function(s, key) {
    .Call(`_CVXR_CseKeys__result_get`, s, key)
}

.CseKeys__result_set <- function(s, key, value) {
    invisible(.Call(`_CVXR_CseKeys__result_set`, s, key, value))
}
