...
## CVXPY SOURCE: atoms/eye_minus_inv.py:127-128 (eye_minus_inv._grad).
## CVXPY returns [None]; CVXPY test_grad.py skip_reason="specialized
## spectral atom". Mirror with list(NULL).
method(.grad, EyeMinusInv) <- function(x, values, ...) {
  list(NULL)
}
