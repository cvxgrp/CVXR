...
partial_transpose <- function(expr, dims, axis = 1L) {
  ...
  ## CVXPY SOURCE: partial_transpose.py:88-94 (CVXPY 1.9.2).
  ## Note there is deliberately NO psd_wrap branch here: partial transpose
  ## does NOT preserve positive semidefiniteness -- that is exactly what
  ## makes it useful as an entanglement witness (the PPT criterion).
