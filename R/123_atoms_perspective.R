...
## CVXPY SOURCE: atoms/perspective.py:140-153 (perspective._grad).
## CVXPY explicitly raises NotImplementedError ("# TODO"). Mirror with
## list(NULL) for each arg so the chain rule walker propagates NULL.
## Perspective is a 2-arg atom (f and t).
method(.grad, Perspective) <- function(x, values, ...) {
  list(NULL, NULL)
}
