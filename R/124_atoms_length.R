...
## per arg, signalling "no gradient" so the chain-rule walker propagates
## NULL up to every variable that flows through Length.
method(.grad, Length) <- function(x, values, ...) {
  list(NULL)
}
